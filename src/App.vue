...
<template>
  <div class="relative flex min-h-full flex-col">
    <header class="mx-auto flex w-full max-w-5xl items-center justify-between px-6 py-6">
      <a href="/" aria-label="eazip.ch">
        <img
          :src="theme === 'dark' ? '/eazip-ch-logo-dark.svg' : '/eazip-ch-logo-light.svg'"
          alt="eazip.ch"
          class="h-10 w-auto"
        />
      </a>
      <div class="flex items-center gap-2">
        <LanguagePicker />
        <a
          href="https://github.com/Zmaon/eazip"
          target="_blank"
        ...
        >
          <svg class="h-5 w-5" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
            <path d="M12 .5C5.65.5.5 5.65.5 12c0 5.08 3.29 9.39 7.86 10.91.58.1.79-.25.79-.56v-2c-3.2.7-3.87-1.37-3.87-1.37-.52-1.33-1.27-1.68-1.27-1.68-1.04-.71.08-.7.08-.7 1.15.08 1.76 1.18 1.76 1.18 1.02 1.76 2.68 1.25 3.34.96.1-.74.4-1.25.72-1.54-2.55-.29-5.24-1.28-5.24-5.69 0-1.26.45-2.29 1.18-3.1-.12-.29-.51-1.46.11-3.04 0 0 .97-.31 3.18 1.18a11.04 11.04 0 0 1 5.78 0c2.2-1.49 3.17-1.18 3.17-1.18.63 1.58.23 2.75.12 3.04.74.81 1.18 1.84 1.18 3.1 0 4.42-2.69 5.39-5.25 5.68.41.36.78 1.06.78 2.13v3.16c0 .31.21.66.8.55 4.57-1.52 7.85-5.83 7.85-10.91C23.5 5.65 18.35.5 12 .5z" />
          </svg>
        </a>
        <button
          type="button"
